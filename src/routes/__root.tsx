...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Da Roça ao Serviço no Altar" },
      {
        name: "description",
        content:
          "Pré-lançamento do livro sobre a vida de Valdemar Joaquim, por Marcos Nascimento.",
      },
      ...
      { property: "og:title", content: "Da Roça ao Serviço no Altar" },
      {
        ...
        content:
          "Uma história simples. Uma vida de fé. Um legado que permanece.",
      },
